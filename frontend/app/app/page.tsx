    ...
    <div className="fixed inset-0 flex flex-col h-[100dvh] w-full max-w-full overflow-hidden bg-[#141B26] text-[#B7BFCB]">
      ...
      <header className="flex items-center justify-between px-3 sm:px-5 py-2 sm:py-3 border-b border-[#2E3A4C] shrink-0 bg-[#141B26] z-[2000]">
        <div className="flex items-center min-w-0">
          <Link href="/" className="flex items-center gap-2 sm:gap-3 shrink-0 hover:opacity-90 transition-opacity" title="Back to GeoMiner Overview">
            ...
            <div>
              <div className="text-[13px] sm:text-[14px] font-semibold text-[#E9E4D6] tracking-[0.2px] leading-tight flex items-center gap-2">
                <span>GeoMiner</span>
                <span className="text-[9px] text-[#C8963E] border border-[#8A6A32] px-1 py-0.2 rounded-xs font-mono uppercase">
                  TERMINAL
                </span>
              </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 ml-2 sm:ml-3 shrink-0">
            ...
            <button
              ...
              className="px-2 sm:px-2.5 py-1 text-[10.5px] sm:text-[11px] font-semibold text-[#C8963E] bg-[#1E2638] hover:bg-[#28344C] hover:text-[#DBA84E] border border-[#C8963E]/40 rounded-xs transition-colors cursor-pointer shrink-0"
